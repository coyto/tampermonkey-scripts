...
// @version      1.0.0
// @author       coyto
// @description  Download videos and photo sets from various sites across the ATK network.
// @icon         https://www.atkpremium.com/css/images/logo.png
// @homepageURL  https://github.com/coyto/tampermonkey-scripts
// @supportURL   https://github.com/coyto/tampermonkey-scripts
// @downloadURL  https://github.com/coyto/tampermonkey-scripts/raw/master/dist/atk-downloader.user.js
// @updateURL    https://github.com/coyto/tampermonkey-scripts/raw/master/dist/atk-downloader.user.js
...
(function () {
  ...
  const handleMoviesIndexPage$2 = () => {
    if (/^\/tour\/movies/.test(pathname$2)) {
      [...document.querySelectorAll(".img-polaroid")].forEach((container) => {
        ...
        const anchorElContainer = document.createElement("div");
        anchorElContainer.className = "date left clear";
        anchorElContainer.style.marginRight = "20px";
        ...
        anchorElContainer.append(hdAnchorEl);
        vidCountEl.insertAdjacentElement("afterend", anchorElContainer);
      });
  ...
  const handleCategoryMoviesIndexPage$2 = () => {
    if (/^\/tour\/type\hardcore/.test(pathname$2)) {
      [...document.querySelectorAll(".img-polaroid")].forEach((container) => {
        const imageEl = container.querySelector("img");
        if (!imageEl) {
          return;
  ...
  const handleATKExotics = () => {
    ...
    handleCategoryMoviesIndexPage$2();
    handleModelPage$2();
